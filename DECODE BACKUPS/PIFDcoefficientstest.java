...
@TeleOp(name="Liam's PIDF test")
public class PIFDcoefficientstest extends LinearOpMode {
    ...
    // PF coefficients for Haydain to test
    double p = 0;
    double f = 0;
    double scale = 1;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) { //NOTE: I HAVE SWAPPED THE STICK X's FOR A QUICK FIX TO A PROBLEM. FIX IT AND THEN SWITCH THEM BACK!!!
            ...
            */
            ...
            telemetry.addData("Target Velocity:", flywheelPower);
