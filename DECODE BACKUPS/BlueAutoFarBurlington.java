...
public class BlueAutoFarBurlington extends LinearOpMode {
            ...
            switch (stage) {
                ...
                case 8:
                    if(startTime.seconds() >= 0){
                        ...
                        Movement(-0.65, -0.7, 0, 0.8); // backright to get into shooting position CHANGE THIS
                        WaitForDrive();
                        stage += 1;
                        startTime.reset();
                    }
