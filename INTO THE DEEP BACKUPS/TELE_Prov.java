...
import java.util.List;
    ...
    @TeleOp(name = "TEST_Provincials Tele")

    public class TELE_Prov extends LinearOpMode{
    ...
    private VisionPortal visionPortal;
        ...
        public void runOpMode(){
            ...
            while (opModeIsActive()){
                ...
                if (gamepad1.right_bumper && SubArmMotor.getCurrentPosition()>-2866){
                    ...
                    SubArmMotor.setTargetPosition(-2620); //height for grabbing from floor
                    SubArmMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    ...
                    SubArmMotor.setTargetPosition(-2825);
                    SubArmMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    SubArmMotor.setPower(1);
                }
                //------------------------------------------------------------------
                ...
                if (gamepad2.left_bumper && SpecArmMotor.getCurrentPosition()>-3500){
                    ...
                    SpecArmMotor.setTargetPosition(-455);
                    SpecArmMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    SpecArmMotor.setPower(1);
                } else if (gamepad2.back){
                    SpecArmMotor.setTargetPosition(-2780);
                    SpecArmMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    SpecArmMotor.setPower(1);
                ...
                if (gamepad2.x){
                    ...
                    SpecArmMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    SpecArmMotor.setPower(1);
                    Asyncronous_Movement(1, 100,"FL");
                    Asyncronous_Movement(1, 100, "L");
                    Asyncronous_Movement(1, 100, "F");
                }
                ...
                */
                ...
                telemetry.addData("ROTATION",subRotation.getPosition());
                telemetry.update();
        ...
        private void Asyncronous_Movement(double power, int its, String direction){
