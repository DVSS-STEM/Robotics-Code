...
@TeleOp(name = "2nd FTC Provincials Tele")

public class Provincials_2 extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()){
            ...
            if (gamepad1.right_bumper && SubArmMotor.getCurrentPosition()>-2866){
                ...
                SubArmMotor.setTargetPosition(-2700);
                SubArmMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                SubArmMotor.setPower(0.5);
            }
            //subRotation.setPosition(ROTATE_POS);
    ...
    private void controllerDriveInput(){
        ...
        if (U2){
            ...
            frontLeftPower = -0.3*r2;
            frontRightPower = 0.3*r2;
            backLeftPower = -0.3*r2;
            backRightPower = 0.3*r2;
        }
    ...
    private double Deadzone (double joystick_axis){
