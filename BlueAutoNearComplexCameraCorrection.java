...
public class BlueAutoNearComplexCameraCorrection extends LinearOpMode {
            ...
            switch (stage) {
                ...
                case 4:
                    if(startTime.seconds() >= 6){
                        rollServo.setPosition(0); // engages blocker
                        flyWheelMotor.setVelocityPIDFCoefficients(100, 0, 0, 15); // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE Maybe
                        flyWheelMotor.setVelocity(1195); // might change to 1 for convinience
                        Movement(-0.9, -1.05, -40, 1); // goes backwards and looks at pieces // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        WaitForDrive();
                        stage += 1;
                        startTime.reset();
                    }
                ...
                case 5:
                    if(startTime.seconds() >= 0){
                        Movement(0.8, 0, 0, 1); // forward to pick up pieces // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        WaitForDrive();
                        stage += 1;
                        startTime.reset();
                    }
                ...
                case 6:
                    if(startTime.seconds() >= 0){
                        hoodServo.setPosition(42.33 * Math.PI / 180); // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE Maybe
                        intakeMotor.setVelocity(0);// stops intaking to avoid misfires MAYBE MOVE THIS???
                        Movement(-0.7, 0.6, 40, 1); // back and looks at goal // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        WaitForDrive();
                        stage += 1;
                        startTime.reset();
                    }
                ...
                case 7:
                    if(startTime.seconds() >= 0){
                        ...
                        Center(0, 1.25, 0); // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        intakeMotor.setVelocity(2000); // intakes to fire
                        stage += 1;
                        startTime.reset();
                    }
                    break;
                case 8:
                    if(startTime.seconds() >= 6){
                        rollServo.setPosition(0); // engages blocker
                        Movement(-0.75, -1, -40, 1); // moves and looks at balls // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        WaitForDrive();
                        stage += 1;
                        startTime.reset();
                    }
                ...
                case 9:
                    if(startTime.seconds() >= 0){
                        Movement(0.8, 0, 0, 1); // picks up balls // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        WaitForDrive();
                        stage += 1;
                        startTime.reset();
                    }
                ...
                case 16:
                    if(startTime.seconds() >= 0){
                        Movement(0, -0.5, 0, 1); // CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE CHANGE
                        WaitForDrive();
                    }
            }
        }
